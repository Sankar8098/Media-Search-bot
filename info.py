...
BOT_TOKEN = environ['5992501587:AAHdDLpHnleGcpCQUizT1efHLhDNYUrtuYA']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ['5821871362'].split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ['-1002145600271'].split()]
